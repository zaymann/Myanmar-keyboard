...
core/
  ...
  custom.sample.txt  template for your own shortcuts / overrides
...
### Customise your own shortcuts

Copy [core/custom.sample.txt](core/custom.sample.txt) to `~/.myanmar-ime/custom.txt`
(Windows: `%USERPROFILE%\.myanmar-ime\custom.txt`), add lines like
`mingalar = မင်္ဂလာ`, and restart the keyboard. See
[ROMANIZATION.md §7](core/ROMANIZATION.md).
...
- ✅ User customisation — add your own shortcuts in `custom.txt` (no rebuild)
